                            ...
                            <div class="item_body_img">
                                <div class="item_link d-flex align-items-center justify-content-center border mt-2 mb-2">
                                    <label>
                                        ...
                                        <img class="item_image img-fluid-a" src="{{ \Storage::url($tops_item->image) }}">
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="item_body_img">
                                <div class="item_link d-flex align-items-center justify-content-center border mt-2 mb-2">
                                    <label>
                                        ...
                                        <img class="item_image img-fluid-a" src="{{ \Storage::url($bottoms_item->image) }}">
                                    </label>
                                </div>
                            </div>
                            <div class="item_body_name">
                            ...
                            <div class="item_body_img">
                                <div class="item_link d-flex align-items-center justify-content-center border mt-2 mb-2">
                                    <label>
                                        ...
                                        <img class="item_image img-fluid-a" src="{{ \Storage::url($shoes_item->image) }}">
                                    </label>
                                </div>
                            </div>
                            <div class="item_body_name">
                            ...
                            <div class="item_body_img">
                                <div class="item_link d-flex align-items-center justify-content-center border mt-2 mb-2">
                                    <label>
                                        ...
                                        <img class="item_image img-fluid-a" src="{{ \Storage::url($outer_item->image) }}">
                                    </label>
                                </div>
                            </div>
                            <div class="item_body_name">
                            ...
                            <div class="item_body_img">
                                <div class="item_link d-flex align-items-center justify-content-center border mt-2 mb-2">
                                    <label>
                                        ...
                                        <img class="item_image img-fluid-a" src="{{ \Storage::url($bag_item->image) }}">
                                    </label>
                                </div>
                            </div>
                            <div class="item_body_name">
